...
public class CreateDB {
    ...
    public static void saveToDatabase(String username, String password, BigDecimal balance) {
        String url = "jdbc:sqlite:BankOfCanedo.db";

        try (Connection connection = DriverManager.getConnection(url);
             PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO accounts(username, password, balance) VALUES (?, ?, ?)")) {
